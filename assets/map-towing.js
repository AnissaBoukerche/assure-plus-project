...
async function createMarkers() {
  ...
  garages.forEach((garage) => {
    L.marker([garage.latitude, garage.longitude]).addTo(map)
      .bindPopup(`Service de remorquage du ${garage.name}. Besoin d'une dépanneuse ?<br/><button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalTowing">
      Réserver
    </button>`);
  });
}
...
const modalTowing = document.getElementById('modalTowing');
